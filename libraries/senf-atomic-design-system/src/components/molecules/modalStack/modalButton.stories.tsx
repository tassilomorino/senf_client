...
const Template: Story<SwipeModalProps> = (args) => (
  <ModalButton
    {...args}
    style={{ margin: "20px" }}
  />
...
Default.args = {
  ...
  children: <p>Content of a Default Modal</p>,
};
...
Swipe.args = {
  ...
  children: <p>Content of a Swipe Modal</p>,
};
...
Sized.args = {
  ...
  children: (
    ...
    >
      ...
      />
      <ModalButton
        text="Open medium modal (default)"
        options={{
          size: "md",
