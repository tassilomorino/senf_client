...
const InviteMember = ({ getPendingDivisionUsers, division }) => {
  ...
  const handleSendInvite = async () => {
    ...
    const invitationLink = `http://localhost:3001/invitation?invitationId=${invitationId}`;
    const heading = `You have been invited to join the organization ${currentMonitoringBoard.title}.`;
    const image =
