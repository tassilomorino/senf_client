import { createContext, createElement, createRef, Children, cloneElement, PureComponent } from 'react';
...
function S(t, e) {
  if (t) {
    ...
    return "Object" === o && t.constructor && (o = t.constructor.name), "Map" === o || "Set" === o ? Array.from(t) : "Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o) ? x(t, e) : void 0;
  }
}
...
var O = function (t) {
  ...
  return t.queryRenderedFeatures(o, n);
    ...
    A = ["id", "before", "onClick"],
    U = [["onClick", "click"], ["onHover", "mousemove"], ["onEnter", "mouseenter"], ["onLeave", "mouseleave"]],
    M = function (t) {
  d(n, PureComponent);
  var r = b(n);
  ...
  function n(t) {
    var e;
    return p(this, n), f(g(e = r.call(this, t)), "$key", void 0), f(g(e), "$value", void 0), f(g(e), "_id", void 0), f(g(e), "_map", void 0), f(g(e), "_onClick", void 0), f(g(e), "_onHover", void 0), f(g(e), "_onEnter", void 0), f(g(e), "_onLeave", void 0), f(g(e), "_addLayer", function (t) {
      var o = e._map,
          r = t.before;
      t.radius, t.onClick, t.onHover, t.onEnter, t.onLeave;
      var n = v(t, P);
      r && o.getLayer(r) ? o.addLayer(n, r) : o.addLayer(n), e._addEventListeners(t);
      ...
      U.forEach(function (r) {
        var n = w(r, 2),
            ...
            a = n[1],
            s = "_".concat(i);
        !o[i] && t[i] && e._map.off(a, e._id, e[s]), o[i] && !t[i] && e._map.on(a, e._id, e[s]);
      });
      ...
      e.props.onClick(u(u({}, t), {}, {
        features: r
      }));
    }), f(g(e), "_onHover", function (t) {
      var o = [t.point.x, t.point.y],
          r = D(e._map, e._id, o, e.props.radius);
      e.props.onHover(u(u({}, t), {}, {
        features: r
      }));
    }), f(g(e), "_onEnter", function (t) {
      var o = [t.point.x, t.point.y],
          r = D(e._map, e._id, o, e.props.radius);
      e.props.onEnter(u(u({}, t), {}, {
        features: r
      }));
    }), f(g(e), "_onLeave", function (t) {
      var o = [t.point.x, t.point.y],
          r = D(e._map, e._id, o, e.props.radius);
      e.props.onLeave(u(u({}, t), {}, {
        features: r
      }));
    }), e._id = t.id, e;
  }
  ...
  return h(n, [{
    ...
    value: function (t) {
      ...
      i !== t.before && i && o.getLayer(i) && o.moveLayer(this._id, i), a.paint !== t.paint && E(a.paint, t.paint).forEach(function (t) {
        var r = w(t, 2),
            n = r[0],
            i = r[1];
        o.setPaintProperty(e._id, n, i);
      }), a.layout !== t.layout && E(a.layout, t.layout).forEach(function (t) {
        var r = w(t, 2),
            n = r[0],
            i = r[1];
    ...
    value: function () {
      var t = this;
      return createElement(L.Consumer, {}, function (e) {
...
f(M, "displayName", "Layer"), f(M, "defaultProps", {
  radius: 0
});
...
var I = function (t) {
  ...
  function n() {
    ...
    return f(g(t = r.call.apply(r, [this].concat(o))), "_id", void 0), f(g(t), "_map", void 0), t;
  }
...
var z = [M, I],
  ...
  return z.includes(t.type);
    ...
    F = function t(e, o) {
  Children.forEach(o, function (o) {
    o && (R(o) && e(o), o.props && o.props.children && t(e, o.props.children));
  });
},
    B = function (t) {
  var e = [];
  ...
  function s(t) {
    var e;
    return p(this, s), f(g(e = a.call(this, t)), "_map", void 0), f(g(e), "_container", void 0), f(g(e), "state", {
      loaded: !1
    ...
    }), C && (C.accessToken = t.accessToken), e._container = createRef(), e;
  }
  ...
  return h(s, [{
    ...
    value: function () {
      ...
      if (C) {
        ...
        }), this.props.onViewportChange && (o.on("dragend", this._onViewportChange), o.on("zoomend", this._onViewportChange), o.on("rotateend", this._onViewportChange), o.on("pitchend", this._onViewportChange), o.on("boxzoomend", this._onViewportChange)), T.forEach(function (e) {
          var r = "on".concat(O(e)),
              n = t.props[r];
          n && (Array.isArray(n) ? o.on.apply(o, [e].concat(k(n))) : o.on(e, n));
    ...
    value: function (t, e) {
      ...
      T.forEach(function (r) {
        ...
        if (!(Array.isArray(i) && Array.isArray(a) && j(i, a) || i === a)) {
          var s, l;
          if (i) if (Array.isArray(i)) (s = o._map).off.apply(s, [r].concat(k(i)));else o._map.off(r, i);
          if (a) if (Array.isArray(a)) (l = o._map).on.apply(l, [r].concat(k(a)));else o._map.on(r, a);
        }
      });
    }
  }, {
    ...
    value: function () {
      var t = this.state.loaded,
        ...
        var e = B(t);
        return e.shift(), function t(o) {
          return "function" == typeof o ? o : Children.map(o, function (o) {
            if (!o) return o;
            ...
            return o.props && o.props.children ? cloneElement(o, {
...
f(W, "displayName", "MapGL"), f(W, "defaultProps", {
  children: null,
  className: null,
  style: null,
...
var N = function (t) {
  ...
  function n() {
    ...
    return f(g(t = r.call.apply(r, [this].concat(o))), "_map", void 0), f(g(t), "state", {
      loaded: !1
    }), f(g(t), "_onSourceData", function () {
      t._map.isSourceLoaded(t.props.id) && (t._map.off("sourcedata", t._onSourceData), t.setState({
        loaded: !0
      }));
      ...
      if (r.url !== o.url || !j(r.tiles, o.tiles)) {
        ...
        n._tileJSONRequest && n._tileJSONRequest.cancel(), n.url = r.url, n.scheme = r.scheme, n._options = u(u({}, n._options), r);
  ...
  return h(n, [{
    ...
    value: function () {
      ...
      var o = v(t, Z),
          r = N(o);
      this._map.addSource(e, r), this._map.on("sourcedata", this._onSourceData);
    }
  }, {
    key: "componentDidUpdate",
    value: function (t) {
      ...
      var a = v(n, $),
          s = N(a);
      if (i !== e || s.type !== r.type) return this._map.removeSource(e), void this._map.addSource(i, s);
      "geojson" !== s.type || "geojson" !== r.type ? "image" !== s.type || "image" !== r.type ? "vector" !== s.type || "vector" !== r.type ? "raster" === s.type && "raster" === r.type && this._updateTileSource(i, r, s) : this._updateTileSource(i, r, s) : this._updateImageSource(i, r, s) : this._updateGeoJSONSource(i, r, s);
    }
  }, {
    key: "componentWillUnmount",
    value: function () {
...
var H = function (t) {
  ...
  function n(t) {
    var e;
    return p(this, n), f(g(e = r.call(this, t)), "_map", void 0), f(g(e), "_el", void 0), f(g(e), "_popup", void 0), e._el = document.createElement("div"), e;
  }
  ...
  return h(n, [{
    ...
    value: function () {
      var t = this;
      return createElement(L.Consumer, {}, function (e) {
        return e && (t._map = e), createPortal(t.props.children, t._el);
      });
    }
  }]), n;
}();

f(H, "displayName", "Popup"), f(H, "defaultProps", {
  closeButton: !0,
  closeOnClick: !0,
  onClose: null,
  anchor: null,
...
var G = function (t) {
  ...
  function n(t) {
    var e;
    return p(this, n), f(g(e = r.call(this, t)), "_map", void 0), f(g(e), "_el", void 0), f(g(e), "_marker", void 0), f(g(e), "_onDragEnd", function () {
    ...
    }), e._el = document.createElement("div"), e;
  }
  ...
  return h(n, [{
    ...
    value: function () {
      ...
      }), this._marker.setLngLat([e, o]).addTo(this._map), r && this._el.addEventListener("click", r), n && this._marker.on("dragend", this._onDragEnd), i && this._marker.on("dragstart", this._onDragStart), a && this._marker.on("drag", this._onDrag);
    }
  }, {
    key: "componentDidUpdate",
    value: function (t) {
...
f(G, "displayName", "Marker"), f(G, "defaultProps", {
  anchor: "center",
  offset: null,
  draggable: !1,
  rotation: 0,
...
var J = function (t) {
  ...
  function n(t) {
    var e;
    return p(this, n), f(g(e = r.call(this, t)), "_map", void 0), f(g(e), "_id", void 0), f(g(e), "_loadImage", function (t, o) {
      "string" != typeof t ? o(t) : e._map.loadImage(t, function (t, e) {
        if (t) throw t;
        o(e);
      });
    }), e._id = t.id, e;
...
var Q = function (t) {
  ...
  function n() {
    ...
    return f(g(t = r.call.apply(r, [this].concat(o))), "_map", void 0), f(g(t), "_control", void 0), t;
  }
...
var Y = function (t) {
  ...
  return h(n, [{
    ...
    value: function () {
      ...
      s && c.on("trackuserlocationend", s), l && c.on("trackuserlocationstart", l), u && c.on("error", u), p && c.on("geolocate", p), t.addControl(c, a), this._control = c;
    }
  }, {
    key: "componentWillUnmount",
    value: function () {
...
var rt = ot(function (t) {
  ...
  function n() {
    ...
    return f(g(t = r.call.apply(r, [this].concat(o))), "_map", void 0), f(g(t), "_control", void 0), f(g(t), "_setLanguage", function () {
...
var it = ot(function (t) {
    ...
    if (!this._hasTraffic()) {
      ...
      var t = this._map.getStyle().layers.filter(function (t) {
        return "road" === t["source-layer"];
          ...
          o = t[t.length - 1].id,
          r = function (t, e, o) {
        for (var r = 0; r < t.layers.length; r++) if (o === t.layers[r].id) {
  ...
  function n() {
    ...
    return f(g(t = r.call.apply(r, [this].concat(o))), "_map", void 0), f(g(t), "_control", void 0), f(g(t), "_addControl", function () {
      var e = t.props,
          o = e.showTraffic,
...
class Draw extends PureComponent {
  ...
  render() {
    return createElement(L.Consumer, {}, map => {
      if (map) {
        // $FlowFixMe
        this._map = map;
      }
